...
SECRET_KEY = 'django-insecure-8m_-xcl4r!cwh(vqk(4*&fsc(n-rczu9qtsd1#3n+mril)g$a@'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'backup/static')

MEDIA_URL = '/backup/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'backup/media')

STATICFILES_STORAGE = "whitenoise.storage.CompressedManifestStaticFilesStorage"

LOGIN_URL = 'https://dallolbingohouse.com/backup/account/login/'
