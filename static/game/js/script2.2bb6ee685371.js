...
gameForm.addEventListener('submit', (e) => {
    ...
    if (typeof cashier !== 'undefined' && cashier === true) {
        ...
        socket.onmessage = function (e) {
            ...
            if (data.action === 'existing_selected_cards') {
                ...
                for (let cashierId in cardMap) {
                    ...
                    console.log("cashierId:", cashierId, "cards:", cards, "typeof cards:", typeof cards);
                    ...
                    if (Array.isArray(cards)) {
                        ...
                        console.warn("Expected an array, but got:", cards);
                    }
                }
            ...
            if (data.action === 'game_started' && data.success && data.game_id) {
